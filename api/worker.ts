...
const HOST_COOKIE_NAME = "queue_host_auth";
const HOST_COOKIE_MAX_AGE_SECONDS = 60 * 60 * 24 * 7; // 7 days
...
async function generateHostCookieValue(sessionId: string, secret: string): Promise<string> {
...
async function verifyHostCookie(cookieValue: string, sessionId: string, secret: string): Promise<boolean> {
